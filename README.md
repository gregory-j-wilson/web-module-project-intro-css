...
- [will do] Host your website on Netlify.com
...
- [will do] Submit a pull request to merge <firstName-lastName> Branch into master (student's  Repo). **Please don't merge your own pull request**
- [will do] Add your Team Lead as a reviewer on the pull request
- [he will do] Your Team Lead will count the project as complete by merging the branch back into master
